      ...
      {({ deleteTask, updateTask, clearForm }) => <Form key={id + '-form-container'}>
        ...
        <div className='field is-horizontal'>
          ...
          <div className='field-body'>
            <div className='field'>
              <p className='control'>
                <Button className='button is-primary' type='button' value='Save' onClick={() => teamName ? updateTask({ id, description, related, sp, story, summary, teamName }) : window.alert('Select Team!')} />
